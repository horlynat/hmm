...
class SeedContentCommand extends Command
{
    ...
    private function seedAboutContent(\App\Entity\AboutContent $c): void
    {
        $c->setHeroEyebrow('Développeur, entrepreneur, consultant en cybersécurité')
            ...
            ->setBioP1("Huit ans dans le secteur de l'assurance, dont cinq comme responsable des risques divers, transports, corps et facultés pour un assureur majeur au Congo — à gérer des portefeuilles complexes, encadrer des équipes commerciales et garantir un taux de renouvellement client au-dessus de 80% chaque année. C'est là que j'ai appris à raisonner en termes de risque avant de raisonner en termes de code.")
            ->setBioP1En("Eight years in the insurance industry, five of them as head of miscellaneous risks, transport, hull and cargo for a major insurer in Congo — managing complex portfolios, leading commercial teams, and keeping client renewal rates above 80% every year. That's where I learned to reason in terms of risk before reasoning in terms of code.")
            ->setBioP2("En parallèle, dès 2016, j'ai développé ma véritable passion : le développement web. En 2018, j'ai pris la responsabilité informatique d'une entreprise, où j'ai conçu des solutions digitales sur mesure tout en assurant la sécurisation des actifs numériques — c'est là qu'est né mon intérêt pour la cybersécurité, que j'ai depuis approfondi en consultant.")
            ->setBioP2En("In parallel, starting in 2016, I developed my real passion: web development. In 2018, I took over IT responsibility at a company, designing tailor-made digital solutions while securing its digital assets — that's where my interest in cybersecurity was born, and I've since deepened it as a consultant.")
            ...
            ->setWhy3Title("Architectures prêtes pour l'IA")
            ->setWhy3TitleEn('AI-ready architectures')
            ->setWhy3Desc("Je conçois des systèmes pensés dès le départ pour accueillir des automatisations et des assistants IA au service du produit — jamais plaqués après coup comme argument marketing.")
            ->setWhy3DescEn('I design systems built from the start to accommodate automation and AI assistants in service of the product — never bolted on afterward as a marketing buzzword.')
